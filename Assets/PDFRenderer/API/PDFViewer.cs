...
namespace Paroxe.PdfRenderer
{
    ...
    public class PDFViewer : UIBehaviour, IPDFDevice, IPDFColoredRectListProvider
    {
        ...
        private void SetProgress(float progress)
        {
            ...
            {
                m_Internal.m_ProgressRect.sizeDelta = new Vector2(progress*rectTransform.sizeDelta.x,
                    m_Internal.m_ProgressRect.sizeDelta.y);
            }
            m_Internal.m_ProgressLabel.text = ((int) (progress*100)) + "%";
        }
        ...
        protected override void Start()
        {
            ...
            m_LinksActionHandler = new PDFViewerDefaultActionHandler();
            m_BookmarksActionHandler = new PDFViewerDefaultActionHandler();
        }
        ...
        void LateUpdate()
        {
            ...
            m_ViewportSize = ComputeRectTransformFinalSize(m_Internal.m_Viewport);
            if (m_Canvas != null)
            {
                m_ViewportSize.x /= m_Canvas.scaleFactor;
                m_ViewportSize.y /= m_Canvas.scaleFactor;
        ...
        private void UpdateScrollBarVisibility()
        {
            ...
            {
                vScrollVisible = (m_Internal.m_PageContainer.sizeDelta.y > m_ViewportSize.y);
                hScrollVisible = (m_Internal.m_PageContainer.sizeDelta.x > m_ViewportSize.x);
            }
            ...
            if (!hScrollVisible)
            {
                ...
                if (m_Internal.m_HorizontalScrollBar.gameObject.activeInHierarchy)
                {
            ...
            if (!vScrollVisible)
            {
                ...
                if (m_Internal.m_VerticalScrollBar.gameObject.activeInHierarchy)
                {
        ...
        public void ZoomOnParagraph(PDFViewerPage viewerPage, Rect pageRect)
        {
            ...
            if (m_ZoomToGo < m_ParagraphZoomFactor)
                ZoomCommon(new Vector2(0.0f, m_ViewportSize.y * 0.5f), true, true, m_ParagraphZoomFactor);
#endif
        }
    }
}
